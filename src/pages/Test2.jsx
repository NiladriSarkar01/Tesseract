...
const Test2 = ({ onComplete }) => {
    ...
    <div className="absolute inset-0 bg-[#020408] flex items-center justify-center z-40 overflow-hidden">
      ...
      <div className="relative text-center transform scale-150 animate-in zoom-in duration-[2000ms] ease-out">
         <div className="relative inline-block">
           <Zap size={80} className="mx-auto text-red-500 mb-6 animate-[ping_1s_ease-in-out_infinite] opacity-80" />
           <Zap size={80} className="absolute top-0 left-0 text-white mix-blend-overlay" />
         </div>
         <h1 className="text-6xl md:text-9xl font-black text-white tracking-tighter leading-none mix-blend-difference filter drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]">
           TECH<br/><span className="text-red-600">VERSE</span>
         </h1>
    ...
    <div className="absolute inset-0 bg-black flex flex-col items-center justify-center z-40">
       <div className="relative border-y-4 border-red-600 py-12 w-full text-center bg-red-900/20 backdrop-blur-lg animate-in zoom-in duration-700">
          <div className="overflow-hidden mb-4">
             <p className="text-3xl md:text-5xl text-white font-black tracking-[0.2em] animate-in slide-in-from-bottom duration-1000 delay-100">NOVEMBER 15-17</p>
          </div>
          <div className="overflow-hidden">
             <p className="text-xl md:text-2xl text-red-400 font-mono uppercase tracking-widest animate-in slide-in-from-top duration-1000 delay-300">Silicon Valley, CA</p>
          </div>
       </div>
  ...
  return (
    <div className="relative w-full h-screen bg-black overflow-hidden font-sans selection:bg-red-500 selection:text-white">
