...
const GalleryHero = () => {
  ...
  return (
    <section className="relative w-full h-[80vh] bg-transparent overflow-hidden flex flex-col items-center justify-center font-sans text-white perspective-1000">
      ...
      {/* Grid Floor */}
      <div className="absolute bottom-0 w-full h-1/2 bg-[linear-gradient(to_bottom,transparent_0%,#ef444410_100%)] mask-[linear-gradient(to_bottom,transparent,black)] pointer-events-none">
      ...
      >
        ...
        <div className="mb-8 relative inline-block group">
          ...
          <div className="relative w-24 h-24 border border-red-500/30 bg-black/50 backdrop-blur-md rounded-2xl flex items-center justify-center transform rotate-45 group-hover:rotate-90 transition-transform duration-700 shadow-2xl shadow-red-900/20">
             <Aperture size={48} className="text-red-500 transform -rotate-45 group-hover:-rotate-90 transition-transform duration-700" />
          </div>
          {/* Decorative corners */}
        ...
        <h1 className="text-6xl md:text-9xl font-black tracking-tighter mb-2 relative select-none">
          ...
          <span className="absolute top-0 left-0 text-red-600/20 blur-sm z-0 transform translate-x-1 translate-y-1">
            LAGACY-DATABASE
          </span>
        </h1>

        <div className="flex items-center justify-center gap-4 text-sm font-mono text-red-400/80 tracking-[0.3em] uppercase">
      ...
      <div className="absolute bottom-10 flex flex-col items-center gap-2 opacity-50 animate-bounce">
        <span className="text-[10px] font-mono tracking-widest text-gray-500">SCROLL_TO_ACCESS</span>
