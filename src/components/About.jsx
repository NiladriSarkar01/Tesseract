...
const AboutTesseract = () => {
  ...
  const tesseractContent = {
    ...
    paragraph: "<span class=\"text-white font-bold\">TESSERACT</span> is the annual techno - cultural fest organized by Guru Nanak Institute of Technology. It's an exciting event that celebrates the technical expertise and artistic talents of aspiring engineers. The event brings together participants from across the state, making it one of the most prestigious events of its kind. The <span class=\"text-blue-400 font-bold\">two-day</span> mega event is a visual treat for attendees, transporting them to another world with a variety of captivating performances by aspiring engineers and artists. From technical competitions to cultural events, <span class=\"text-white font-bold\">TESSERACT</span> offers a diverse range of activities that cater to everyone's interests."
  };
      ...
      <div className="relative z-10 w-full mx-auto px-6 lg:px-12 py-20 md:py-24 border-b border-cyan-900/50"> 
        <div className="max-w-5xl"> 
          <h2 className="text-5xl md:text-8xl font-extrabold leading-tight mb-10">
            <span className="block text-white">{tesseractContent.headingPart1}</span>
            <span className="block text-white">{tesseractContent.headingPart2}</span>
            <span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-500 text-7xl md:text-9xl scale-x-105">{tesseractContent.headingPart3}</span> 
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="lg:col-span-1"> 
                <h2 className="text-5xl md:text-7xl font-extrabold leading-tight mb-8">
                    ...
                    <span className="block text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-blue-400 to-indigo-500">{gnitContent.heading}</span>
                </h2>
